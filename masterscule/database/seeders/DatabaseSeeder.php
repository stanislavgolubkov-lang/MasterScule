...
class DatabaseSeeder extends Seeder
{
    ...
    private function products(Brand $kingTony, Brand $m7, $categories): array
    {
        $items = [
            ...
            [$kingTony, 'dulapuri-si-organizare', 'Carucior scule King Tony 87G07-7B', 'king-tony-87g07-7b', '87G07-7B', 'Carucior cu sertare pentru organizarea atelierului.', 'Carucior de scule King Tony pentru organizarea eficienta a sculelor in service sau atelier. Constructie robusta, sertare multiple si spatiu clar pentru lucru repetat.', 2999, null, '/images/products/product-placeholder-toolbox.svg', true, false, false, ['Tip' => 'Carucior scule', 'Sertare' => '7', 'Utilizare' => 'Atelier', 'Structura' => 'Metalica']],
            [$m7, 'compresoare', 'Compresor M7 AC-100/3M', 'm7-ac-100-3m', 'AC-100/3M', 'Compresor pentru alimentarea sculelor pneumatice.', 'Compresor M7 pentru service si garaj, pregatit pentru lucrari cu scule pneumatice si alimentare constanta cu aer comprimat.', 1599, null, '/images/products/product-placeholder-compressor.svg', true, true, false, ['Tip' => 'Compresor', 'Utilizare' => 'Scule pneumatice', 'Alimentare' => '230V', 'Garantie' => '24 luni']],
